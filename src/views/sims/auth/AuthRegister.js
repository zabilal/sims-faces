...
// step options
const steps = ['School Details', 'Admin Details'];
                ...
                {activeStep === steps.length ? (
                    <>
                        <Typography variant="h5" gutterBottom>
                            Thank you for your registration was successful
                        </Typography>
                        <Typography variant="subtitle1">
                            We have emailed your confirmation, and will send you an update when your order has shipped.
                        </Typography>
